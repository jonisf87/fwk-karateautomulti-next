 ...
 *
 * Mapeos:
 *   ../../README.md                -> modules/docs/pages/readme-repo.adoc
 *   ../../e2e/karate/README.md     -> modules/docs/pages/readme-karate.adoc
 *   ../../code/README.md           -> modules/docs/pages/readme-microservice.adoc
 *   ../../code/archetype-karate-e2e/README.md -> modules/docs/pages/readme-archetype.adoc
 *   ./README.md                    -> modules/docs/pages/readme-docs.adoc
 *
 * Notas:
...
const mappings = [
  {
    ...
    dest: path.resolve(__dirname, "modules/docs/pages/readme-repo.adoc"),
    fallbackTitle: "README del repositorio",
  },
  {
    source: path.resolve(__dirname, "../../e2e/karate/README.md"),
    dest: path.resolve(__dirname, "modules/docs/pages/readme-karate.adoc"),
    fallbackTitle: "README de Karate E2E",
  },
  {
    source: path.resolve(__dirname, "../../code/README.md"),
    dest: path.resolve(
      __dirname,
      "modules/docs/pages/readme-microservice.adoc",
    ),
    fallbackTitle: "README del microservicio",
  },
  {
    source: path.resolve(
      __dirname,
      "../../code/archetype-karate-e2e/README.md",
    ),
    dest: path.resolve(__dirname, "modules/docs/pages/readme-archetype.adoc"),
    fallbackTitle: "README del arquetipo",
  },
  {
    source: path.resolve(__dirname, "./README.md"),
    dest: path.resolve(__dirname, "modules/docs/pages/readme-docs.adoc"),
    fallbackTitle: "README del workspace de docs",
  },
];
  ...
  if (fs.existsSync(dest)) {
    ...
    if (
      !(
        ...
        current.includes(OLD_GENERATED_MARKER)
      )
    ) {
      console.info(
        `[ingest] Archivo existente sin marcador, se omite para preservar ediciones manuales: ${dest}`,
      );
      return;
    }
  }
